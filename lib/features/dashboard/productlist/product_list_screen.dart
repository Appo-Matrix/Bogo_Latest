...
import 'package:bogo_latest/features/dashboard/productlist/widgets/product_item%20_widget.dart';
...
import '../enterPrice/enter_price_screen.dart'; // <-- update the path if different
            ...
            if (selectedIndex != null)
              Positioned(
                ...
                child: InkWell(onTap: (){ Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EnterPriceScreen(),
                  ),
                );},
                  child: Container(
